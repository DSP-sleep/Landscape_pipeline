function warpimg = warpimage(MoveImgPath,ImgType,AffinePath,DeformPath,down_size,original_size,step,interpolation,Parallelmode)
...
warpimg = uint16(zeros(original_size));
...
for i = 1:length(subranges)-1
    ...
    warpimg(:,:,subranges(i):subranges(i+1)-1) = subwarpimg;
